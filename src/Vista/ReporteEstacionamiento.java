 ...
 */
public class ReporteEstacionamiento extends javax.swing.JDialog {
  ...
  MetodoSQLEstacionamiento sql = new MetodoSQLEstacionamiento();
    public ReporteEstacionamiento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        listar2();
    ...
    private void initComponents() {
        ...
        panelbotones.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "REPORTES/ESTACIONAMIENTO", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tw Cen MT Condensed Extra Bold", 0, 18), new java.awt.Color(111, 174, 2))); // NOI18N
        ...
        jPanel1.add(btnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 240, 160, 43));
        ...
        jtRegistro.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "AREA", "PLACA", "FECHA", "PRECIO", "TARIFA", "ENTRADA", "SALIDA"
            }
        ) {
        ...
        jPanel1.add(tablap, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 150, 560, 140));
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 230, 220));
    ...
    void listar2() {
        String sql = "SELECT codigo_area,numero_placa, fecha, precio,tarifa,hora_entrada,hora_salida FROM estacionamiento";
        ...
        try {
            ...
            Object[] asigv = new Object[7];
            modelo = (DefaultTableModel) jtRegistro.getModel();
            while (rs.next()) {
                asigv[2] = rs.getString("fecha");
                asigv[1] = rs.getString("numero_placa");
                asigv[3] = rs.getString("precio");
                asigv[0] = rs.getString("codigo_area");
                asigv[4] = rs.getString("tarifa");               
                asigv[5] = rs.getString("hora_entrada");
                asigv[6] = rs.getString("hora_salida");
