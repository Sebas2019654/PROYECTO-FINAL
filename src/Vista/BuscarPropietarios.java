 ...
 */
public class BuscarPropietarios extends javax.swing.JDialog {

    /**
     * Creates new form mBuscarPersonas
     */
    public BuscarPropietarios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
    }
     metodosSQLPropietarios metodos = new metodosSQLPropietarios();
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 300, 160, 43));
    ...
    private void jtRegistroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtRegistroMousePressed
        // TODO add your handling code here:
        int fila = jtRegistro.getSelectedRow();
        if (fila != -1) {
            try {
                Id = Integer.parseInt(jtRegistro.getValueAt(fila, 7).toString());
                documento = jtRegistro.getValueAt(fila, 0).toString();
                nombre = jtRegistro.getValueAt(fila, 1).toString();
                apellido = jtRegistro.getValueAt(fila,2).toString();
                domicilio = jtRegistro.getValueAt(fila, 3).toString();
                telf = Integer.parseInt(jtRegistro.getValueAt(fila, 4).toString());
                edad = Integer.parseInt(jtRegistro.getValueAt(fila, 5).toString());
                correo = jtRegistro.getValueAt(fila, 6).toString();
    ...
    }//GEN-LAST:event_jtRegistroMousePressed
